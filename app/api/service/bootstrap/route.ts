...
export async function GET(request: Request) {
  ...
  return NextResponse.json({ user, tables, menu: hostingerMenu, categories: hostingerCategories, addons: hostingerAddons, checks: openChecks }, { headers: { "Cache-Control": "no-store" } });
}
